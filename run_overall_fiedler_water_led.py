...
def main():
    print("==================================================================")
    print("      Water-Led (Solvent-Only Fiedler) Folding Simulator")
    print("==================================================================")
    print("Starting water-led visualizer backend and dev servers...")
    
    # 1. Launch the Flask Backend on port 5009
    backend_process = subprocess.Popen(
        [sys.executable, "server_overall_fiedler_water_led.py"]
    )
    
    # Give the backend a moment to bind to port 5009
    time.sleep(1.0)
    print("✓ Water-Led Backend Server started at: http://localhost:5009")
