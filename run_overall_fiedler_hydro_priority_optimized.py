...
def main():
    print("==================================================================")
    print("      Optimized Overall Fiedler Folding Simulator (Hydro-Priority)")
    print("==================================================================")
    print("Starting optimized visualizer backend and dev servers...")
    
    # 1. Launch the Flask Backend on port 5009
    backend_process = subprocess.Popen(
        [sys.executable, "server_overall_fiedler_hydro_priority_optimized.py"]
    )
    
    # Give the backend a moment to bind to port 5009
    time.sleep(1.0)
    print("✓ Optimized Backend Server started at: http://localhost:5009")
