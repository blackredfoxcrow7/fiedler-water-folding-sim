            ...
            for cycle in range(n_cycles):
                ...
                for res_idx in inward_order:
                    ...
                    for joint in joints_by_res[res_idx]:
                        ...
                        # We evaluate Fiedler value for each candidate angle by creating a single contact with target residues
                        for d_theta in candidate_angles:
                            ...
                            for target_res_idx in range(peptide.n_residues):
                                ...
                                # Build candidate graph containing only covalent bonds + contacts between res_idx and target_res_idx
                                G_pep_cand = nx.Graph()
                                ...
                                # Add non-covalent edges between active residue atoms and target residue atoms
                                ...
                                # The score is purely the Fiedler connectivity value of this constructive graph!
                                if cand_f > best_angle_score:
                                    best_angle_score = cand_f
                                    best_angle_coords = cand_coords
                                    best_angle_f = cand_f
                                    
                        # Apply best rotation if improvement found over previous score
                        if best_angle_coords is not None:
                            curr_coords = best_angle_coords
                            p_f_init = best_angle_f
                            # Re-evaluate curr_score on overall Fiedler for display
