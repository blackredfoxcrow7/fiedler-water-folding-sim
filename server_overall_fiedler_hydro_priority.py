...
def run_simulation_and_get_structure():
    try:
        ...
        print(f"\n========================================================")
        print(f"  Starting Solvent-Coupled OVERALL Fiedler Folding (Hydrophobic-Priority Phase-Locking)")
        ...
        for trial in range(1, 4):
            ...
            for cycle in range(n_cycles):
                # Phase check: cycles 0-4 are Hydrophobic-Only (prioritize hydrophobic collapse); cycles 5-9 allow both Polar and Hydrophobic
