    ...
    try:
        ...
        for trial in range(1, 4):
            ...
            for cycle in range(n_cycles):
                # Phase check: cycles 0-4 are Polar-Only (prioritize hydrogen bonds); cycles 5-9 allow both Polar and Hydrophobic
                is_polar_only_phase = (cycle < 5)
                    ...
                    for joint in joints_by_res[res_idx]:
                        ...
                        for d_theta in candidate_angles:
                            ...
                            for target_res_idx in range(peptide.n_residues):
                                ...
                                # Add accumulated bonds (subject to phase filter)
                                for r_a, r_b in accumulated_bonds:
                                    ...
                                    for i in atoms_a:
                                        for p in atoms_b:
                                            ...
                                            elif not is_polar_only_phase and is_hydro[i] and is_hydro[p]:
                                                w = 40.0 / (d**2)
                                                if is_sc[i] and is_sc[p]:
                                                    w *= 0.70
                                                elif is_sc[i] or is_sc[p]:
                                ...
                                # Add the new candidate bond (subject to phase filter)
                        ...
                        if best_angle_coords is not None:
                            ...
                            # Add the selected bond to the accumulated set (order independent)
                    ...
                    for joint in joints_by_res[res_idx]:
                        ...
                        for d_theta in candidate_angles:
                            ...
                            for target_res_idx in range(peptide.n_residues):
                                ...
                                # Add new candidate bond (subject to phase filter)
                                target_atoms = np.where(res_arr == target_res_idx)[0]
                                for i in active_atoms:
                                    for p in target_atoms:
                                        d = dists_pep[i, p]
