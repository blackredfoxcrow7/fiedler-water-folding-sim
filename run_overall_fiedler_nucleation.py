...
def main():
    print("==================================================================")
    print("    Water-Coupled Nucleation-Propagation Folding Simulator")
    print("==================================================================")
    print("Starting nucleation visualizer backend and dev servers...")
    
    # 1. Launch the Flask Backend on port 5009
    backend_process = subprocess.Popen(
        [sys.executable, "server_overall_fiedler_nucleation.py"]
    )
    
    # Give the backend a moment to bind to port 5009
    time.sleep(1.0)
    print("✓ Nucleation Backend Server started at: http://localhost:5009")
