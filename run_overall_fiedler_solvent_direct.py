...
def main():
    print("==================================================================")
    print("      Direct Solvent-Coupled Overall Fiedler Folding Simulator")
    print("==================================================================")
    print("Starting solvent-direct visualizer backend and dev servers...")
    
    # 1. Launch the Flask Backend on port 5009
    backend_process = subprocess.Popen(
        [sys.executable, "server_overall_fiedler_solvent_direct.py"]
    )
    
    # Give the backend a moment to bind to port 5009
    time.sleep(1.0)
    print("✓ Solvent-Direct Backend Server started at: http://localhost:5009")
