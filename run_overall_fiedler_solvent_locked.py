...
def main():
    print("==================================================================")
    print("      Water-Coupled Locked-Solvent Folding Simulator")
    print("==================================================================")
    print("Starting locked-solvent visualizer backend and dev servers...")
    
    # 1. Launch the Flask Backend on port 5009
    backend_process = subprocess.Popen(
        [sys.executable, "server_overall_fiedler_solvent_locked.py"]
    )
    
    # Give the backend a moment to bind to port 5009
    time.sleep(1.0)
    print("✓ Locked-Solvent Backend Server started at: http://localhost:5009")
